...
> Fill in after running on your machine / Colab instance.
...
├── plots/                     # generated PNG files land here
└── results/                   # CSV output files land here
```
...
- NVIDIA GPU with Tensor Core support (Volta / Turing / Ampere or newer)
- CUDA Toolkit ≥ 11.0
...
> Run the benchmarks and replace the placeholder images below.
...
> Replace placeholders with your measured values.

| Matrix Size | FP32 Latency (ms) | TF32 Latency (ms) | FP32 TFLOPS | TF32 TFLOPS | Speedup |
|:-----------:|:-----------------:|:-----------------:|:-----------:|:-----------:|:-------:|
| 256         | [X.XX]            | [X.XX]            | [X.XX]      | [X.XX]      | [X.Xx]  |
| 512         | [X.XX]            | [X.XX]            | [X.XX]      | [X.XX]      | [X.Xx]  |
| 1024        | [X.XX]            | [X.XX]            | [X.XX]      | [X.XX]      | [X.Xx]  |
| 2048        | [X.XX]            | [X.XX]            | [X.XX]      | [X.XX]      | [X.Xx]  |
| 4096        | [X.XX]            | [X.XX]            | [X.XX]      | [X.XX]      | [X.Xx]  |
| 8192        | [X.XX]            | [X.XX]            | [X.XX]      | [X.XX]      | [X.Xx]  |
...
Tensor Core throughput advantage compounds: you typically observe near-linear TFLOPS
growth and a clearer speedup over the FP32 baseline at N ≥ 2048.
